     ...
     <!-- ****** Top Discount Area Start ****** -->
        <section class="top-discount-area d-md-flex align-items-center">
            ...
            <div class="single-discount-area">
                ...
                <h6>USE CODE: WELCOME20</h6>
            </div>
            <!-- Single Discount Area -->
            <div class="single-discount-area">
                <h5>20% Discount for students</h5>
                <h6>USE CODE: STUDENT15</h6>
            </div>
        </section>
        ...
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/banner/b-1.jpg);">
        ...
        <section class="top_catagory_area d-md-flex clearfix">
            ...
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(img/bg-img/bg-6.jpg);">
                <div class="catagory-content">
                    <h6>in Black excepting the new collection</h6>
                    <h2>Love In black</h2>
                    <a href="#" class="btn karl-btn">SHOP NOW</a>
                </div>
            </div>
        ...
        <section class="new_arrivals_area section_padding_100_0 clearfix">
            ...
            <div class="karl-projects-menu mb-100">
                <div class="text-center portfolio-menu">
                    ...
                    <button class="btn" data-filter=".Beauty">Beauty Care</button>
            ...
            <div class="container">
                <div class="row karl-new-arrivals">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item access wow fadeInUpBig" data-wow-delay="0.4s">
                        ...
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs.699</h4>
                            <p>Jeans midi cocktail dress</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.6s">
                        ...
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs.999</h4>
                            <p>Jeans midi cocktail dress</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item kids man wow fadeInUpBig" data-wow-delay="0.7s">
                        ...
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">Rs.799</h4>
                            <p>Jeans midi cocktail dress</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
        ...
        <!-- ****** Offer Area Start ****** -->
        <section class="offer_area height-700 section_padding_100 bg-img" style="background-image: url(img/bg-img/bg-7.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-end justify-content-end">
                    <div class="col-12 col-md-8 col-lg-6">
                        <div class="offer-content-area wow fadeInUp" data-wow-delay="1s">
                            <h2>Top Wear<span class="karl-level">Hot</span></h2>
                            <p>* Free shipping until 13 April 2019</p>
                            <div class="offer-product-price">
                                <h3><span class="regular-price">Rs.699</span> Rs.499</h3>
                            </div>
                    ...
                    <div class="col-12 col-md-8">
                        <div class="karl-testimonials-slides owl-carousel">
                            ...
                            <div class="single-testimonial-area text-center">
                                ...
                                <h6>Customer service is an opportunity to exceed your customer’s expectations. – John Jantsch</h6>
                                <div class="testimonial-info d-flex align-items-center justify-content-center">
                                    <div class="tes-thumbnail">
                                        <img src="img/bg-img/th-1.jpg" alt="">
                                    </div>
                            ...
                            <div class="single-testimonial-area text-center">
                                <span class="quote">"</span>
                                <h6>Always keep in mind the old retail adage: Customers remember the service a lot longer than they remember the price. </h6>
                                <div class="testimonial-info d-flex align-items-center justify-content-center">
                                    <div class="tes-thumbnail">
                            ...
                            <div class="single-testimonial-area text-center">
                                <span class="quote">"</span>
                                <h6>In an era when companies see online support as a way to shield themselves from costly interactions with their customers, it’s time to consider an entirely different approach: building human-centric customer service through great people and clever technology. So, get to know your customers. Humanize them. Humanize yourself. It’s worth it.</h6>
                                <div class="testimonial-info d-flex align-items-center justify-content-center">
                                    <div class="tes-thumbnail">
                                        <img src="img/bg-img/tes-1.jpg" alt="">
                                    </div>
